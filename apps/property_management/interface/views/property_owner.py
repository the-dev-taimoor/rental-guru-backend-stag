...
from apps.property_management.infrastructure.models import Invitation, OwnerInfo, Property
from apps.property_management.interface.serializers import OwnerInfoRetrieveSerializer, OwnerInfoSerializer
