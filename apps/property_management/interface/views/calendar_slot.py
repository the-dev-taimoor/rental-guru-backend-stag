...
from apps.property_management.infrastructure.models import CalendarSlot
from apps.property_management.interface.serializers import CalendarSlotListSerializer, CalendarSlotSerializer
