...
from apps.user_authentication.infrastructure.models import Tenant, Role
from apps.user_authentication.interface.serializers import TenantProfileSerializer
