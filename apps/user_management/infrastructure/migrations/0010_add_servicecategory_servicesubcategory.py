...
def add_service_categories_and_subcategories(apps, schema_editor):
    Category = apps.get_model('user_management', 'ServiceCategory')
    Subcategory = apps.get_model('user_management', 'ServiceSubCategory')
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('user_management', '0009_servicecategory_servicesubcategory'),
    ]
